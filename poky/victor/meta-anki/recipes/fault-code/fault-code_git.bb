...
do_install() {
  install -d ${D}/usr/bin
  install -m 0755 ${S}/fault-code-handler ${D}/usr/bin
  install -m 0755 ${S}/fault-code-clear ${D}/usr/bin
...
FILES:${PN} += "/usr/bin/fault-code-handler"
FILES:${PN} += "/usr/bin/fault-code-clear"
