...
EXTRA_OEMAKE:append_qcs40x = " 'DISABLE_PARALLEL_DOWNLOAD_FLASH=1'"
...
EXTRA_OEMAKE:append = " 'TARGET_NAND_AB_ATTR_SUPPORT=${NAND_AB_ATTR_SUPPORT}'"
NAD_PARTITION = "${@bb.utils.contains('DISTRO_FEATURES', 'nad-prod', '1', '0', d)}"
EXTRA_OEMAKE:append = " 'NAD_PARTITION=${NAD_PARTITION}'"

INITRAMFS = "${@bb.utils.contains('DISTRO_FEATURES', 'initramfs', '1', '0', d)}"
EXTRA_OEMAKE:append = " 'INITRAMFS_BUNDLE=${INITRAMFS}'"
