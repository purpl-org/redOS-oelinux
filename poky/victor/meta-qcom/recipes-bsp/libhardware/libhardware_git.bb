...
EXTRA_OECONF:append_concam = " --enable-camera"
EXTRA_OECONF:append_sdm845 = " --enable-sensors"
EXTRA_OECONF:append_sdm845 = " --enable-camera"
EXTRA_OECONF:append_robot-som = " --enable-camera"
