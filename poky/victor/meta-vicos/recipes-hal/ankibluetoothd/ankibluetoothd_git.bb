inherit autotools pkgconfig systemd gccseven
...
do_install() {
  ...
  if ${@bb.utils.contains('DISTRO_FEATURES', 'systemd', 'true', 'false', d)}; then
    ...
    install -m 0644 ${UNPACKDIR}/ankibluetoothd.service \
  ...
  install -m 0644 ${UNPACKDIR}/smd23.rules ${D}${sysconfdir}/udev/rules.d/smd23.rules
}
