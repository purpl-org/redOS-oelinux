...
FILES:${PN} = ""
FILES:kernel-base = "/lib/modules/${KERNEL_VERSION}/modules.order /lib/modules/${KERNEL_VERSION}/modules.builtin"
FILES:kernel-image = "/boot/${KERNEL_IMAGETYPE}*"
FILES:kernel-dev = "/boot/System.map* /boot/Module.symvers* /boot/config* ${KERNEL_SRC_PATH} /lib/modules/${KERNEL_VERSION}/build"
FILES:kernel-vmlinux = "/boot/vmlinux*"
...
kernel_do_deploy() {
	...
	cp ${COREBASE}/meta/files/deploydir_readme.txt ${DEPLOYDIR}/README_-_DO_NOT_DELETE_FILES:IN_THIS_DIRECTORY.txt
