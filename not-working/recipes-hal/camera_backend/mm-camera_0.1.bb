inherit androidmk qprebuilt androidmk-clang qlicense
...
FILES:${PN}-essential = "${@get_essential_libs(bb, d)}"

# Add remaining chromatix libs to optional package.
FILES:${PN}-optional  = "${libdir}/libchromatix_*.* ${libdir}/libactuator_*.* ${libdir}/libmmcamera_imx*.* ${libdir}/libmmcamera_ov*.* ${libdir}/libmmcamera_s5k*.* /system/etc/camera/*_chromatix*.xml"
